      ...
      <div className="vendor-ticket-row" style={{ paddingTop: offerActive ? 36 : 20 }}>
        ...
        <div style={{ minWidth: 0, flex: 1 }}>
          <div className="vendor-ticket-name-row" style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 5, flexWrap: "wrap" }}>
            ...
            {vendor.isVerified && <span style={{ fontSize: 11, fontWeight: 800, padding: "3px 9px", borderRadius: 999, color: COLORS.ink, background: COLORS.marigold, display: "flex", alignItems: "center", gap: 4 }}>✓ STall Verified</span>}
