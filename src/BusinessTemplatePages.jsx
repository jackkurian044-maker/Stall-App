...
const visitCard = { marginTop:20, background:"#fff", borderRadius:24, padding:"30px", display:"grid", gridTemplateColumns:"minmax(0,1fr) minmax(330px,.95fr)", gap:30, alignItems:"stretch", boxShadow:"0 15px 45px rgba(0,0,0,.06)" };
...
const hoursTime = { color:"#4f4f4f", fontWeight:750, whiteSpace:"nowrap", textAlign:"left" };
