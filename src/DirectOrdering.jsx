...
export function DirectMenuManager({ listingId, user, onBack }) {
  ...
  if(listing.planKey!=="growth_setup")return <div style={page}><div style={box}><h3>STall Direct is available on the eligible Growth plan.</h3></div></div>;
